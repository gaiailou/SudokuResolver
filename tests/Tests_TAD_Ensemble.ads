...
package tests_TAD_Ensemble is
   ...
   function test_iemeChiffre return Boolean;
   function test_iemeChiffreNonCompris return Boolean;
   les_Tests : constant array (Positive range <>) of Test_Unitaire :=
     ...
     (test_iemeChiffre'Access,
       To_Unbounded_String("echec de l'exception test iemeChiffre")),
   (test_iemeChiffreNonCompris'Access,
       To_Unbounded_String("echec de l'exception test iemeChiffreNonCompris")));
