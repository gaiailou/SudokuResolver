...
package body tests_TAD_Ensemble is
   ...
   exception
      ...
      -- Verficiation du fonctionnement de la fonction test_iemeChiffre --
    function test_iemeChiffre return Boolean is
      e : Type_Ensemble;
      v : Integer;
   begin
      e := construireEnsemble;
      ...
      ajouterChiffre(e,9);
      ajouterChiffre(e,7);
      v:=iemeChiffre(e,3);  -- On choisit le n�index en l'occurence
      return v=7;           -- On met la valeur de l'index
      end test_iemeChiffre;
   -- Quand l'index n'existe pas --
      function test_iemeChiffreNonCompris return Boolean is
      e : Type_Ensemble;
      v : Integer;
   begin
      e := construireEnsemble;
      ...
      ajouterChiffre(e,4);
      ajouterChiffre(e,9);
      v:=iemeChiffre(e,13); -- On choisit l'index ici en l'occurence 13, il n'existe pas
      return v=9;        -- On renvoies la valeur de l'index, sachant que l'index n'existe pas
   exception
      when INDEX_NON_VALIDE =>
         return True;
      when others =>
         return False;
   end test_iemeChiffreNonCompris;
